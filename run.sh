...
# # paddleClas
# paddle_clas_path=/home/ezxr/Downloads/PaddleClas
# cd $paddle_clas_path
# python python/get_descriptor.py  -c configs/inference_logo.yaml IndexProcess.gallery_features_outpath="$desc_save_path/db_logo_globaldesc.npy" IndexProcess.gallery_images_outpath="$desc_save_path/db_logo_globalindex.npy" IndexProcess.image_root="$ocr_pathdb" 
# python python/get_descriptor.py  -c configs/inference_logo.yaml IndexProcess.gallery_features_outpath="$desc_save_path/query_logo_globaldesc.npy" IndexProcess.gallery_images_outpath="$desc_save_path/query_logo_globalindex.npy" IndexProcess.image_root="$ocr_pathq" 
# cd - # 回到当前文件夹
# paddle_clas_pairs_list=saved_ibl/paddle_clas_pairs_list.txt
# python pipeline/hfnet_nn.py --input_path $desc_save_path --save_query_prefix query_logo --save_db_prefix query_logo >> $paddle_clas_pairs_list --threshold 0.85
# subFolder=4F 
