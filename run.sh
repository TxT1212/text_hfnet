...
python -m hloc.pipelines.naver.pipeline --loc_pairs /media/txt/data2/naver/HyundaiDepartmentStore/outputs/1F/pairs-query-netvlad20.txt --results /media/txt/data2/naver/HyundaiDepartmentStore/outputs/1F/hloc_superpoint+superglue_netvlad_20.txt --loc_matches /media/txt/data2/naver/HyundaiDepartmentStore/outputs/1F/feats-superpoint-n4096-r1600_matches-superglue_pairs-query-netvlad50.h5
# python -m hloc.pipelines.naver.pipeline --loc_pairs /home/txt/Downloads/ezxr_loc/text_hfnet/saved/logo_nn_f1.txt --results /media/txt/data2/naver/HyundaiDepartmentStore/outputs/1F/hloc_superpoint+superglue_logo_20_.txt
