...
areas = np.load(
    '/home/ezxr/Documents/wxc/pic_ocr_flip/dict_test2xyz.npy', allow_pickle=True)
...
for image_name in dict_test2xyz:
    ...
    if(points.shape[0] < 5):
        ...
        image_names[points.shape[0]-1].append(image_name)
    else:
...
for i in range(0,4):
    print("points: ", i+1)
    for img in image_names[i]:
        print(ocr_outpath + img + ".jpg")
